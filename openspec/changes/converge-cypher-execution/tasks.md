...
- [ ] 3.4 Reproduce then fix #461 and #448; verify atomic publication, embedding flush visibility, reopen and any existing-data repair needs.
	- #461 progress: `TestGH461_AutocommitCreatedRelationshipVisibleAcrossTransactionsAndReopen` verifies one auto-commit CREATE containing nodes+edge, six snapshot pattern forms, subsequent implicit MATCH SET/readback, and persistent reopen. #448 and the legacy existing-record repair assessment remain open.
