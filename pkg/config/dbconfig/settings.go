...
var settingsRegistry = []SettingDefinition{
	...
	{Name: "db.nornic.embedding.labels.include", EnvironmentVariable: "NORNICDB_EMBEDDING_LABELS_INCLUDE", Type: "string", Category: "Embeddings", Description: "Comma-separated labels eligible for managed embedding; empty permits all labels. Exclusions take precedence.", Scope: ScopeDatabase, RestartLevel: RestartProcess},
	{Name: "db.nornic.embedding.labels.exclude", EnvironmentVariable: "NORNICDB_EMBEDDING_LABELS_EXCLUDE", Type: "string", Category: "Embeddings", Description: "Comma-separated labels excluded from managed embedding even when included.", Scope: ScopeDatabase, RestartLevel: RestartProcess},
